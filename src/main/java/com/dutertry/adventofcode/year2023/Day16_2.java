...
public class Day16_2 {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<Beam> startBeams = new LinkedList<>();
            for(int x = 0; x <= maxx; x++) {
                startBeams.add(new Beam(x, -1, DOWN));
                startBeams.add(new Beam(x, maxy+1, UP));
            }
            for(int y = 0; y <= maxy; y++) {
                startBeams.add(new Beam(-1, y, RIGHT));
                startBeams.add(new Beam(maxx+1, y, LEFT));
            }
            ...
            for(Beam startBeam : startBeams) {
                ...
                int energized = energizedTiles.size();
